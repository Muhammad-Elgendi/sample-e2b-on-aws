...
# Use public subnet so the Packer build instance has internet access (apt, docker, etc.)
# Private subnets have no NAT in this template, so builds would fail with "Network is unreachable"
